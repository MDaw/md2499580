...
int main(int argc, char** argv) {
  //Declare Variables
    float pallet,PalWidg,NuWidg,widget=9.2;
    
  //output initial question 
    cout<<"First, how many pounds (lb) does the pallet weigh by itself?"<<endl;
    cin>>pallet;
    cout<<"Next, how many pounds does the pallet weigh with the widgets stacked on it?"<<endl;
